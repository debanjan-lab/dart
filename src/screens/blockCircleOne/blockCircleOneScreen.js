              ...
              {this.state.apiExecute ? (
                <View>
                          ...
                          {item.circleUsers !== undefined
                            ? item.circleUsers.map((user_item, user_index) => (
                                ...
                                >
                                  <View
                                    style={
                                      onGoingCircleStyle.nextRowViewLeftItem
                                    }
                                  >
                                    <Text
                    ...
                    <View style={onGoingCircleStyle.tableContent}>
                      <ScrollView>
                        <View style={onGoingCircleStyle.tablePart}>
                          ...
                          <View>
                            {item.circleUsers.map((user_item, user_index) => (
                              ...
                              >
                                ...
                                <View
                                  style={onGoingCircleStyle.rowViewRightItem}
                                >
                          ...
                          <View
                            style={
                              blockCircleOneStyle.tableContentPaymentHistory
                            }
                          >
                            <ScrollView>
                              <View style={blockCircleOneStyle.tablePart}>
                                ...
                                {item.circleUsers.map(
                                  (user_item, user_index) => (
                                    <View key={user_index}>
                                      {user_item.current_round_payment_status ==
                                      0 ? (
                                        <View
                                          style={blockCircleOneStyle.rowView}
                                        >
                                          <View
                                            style={
                  ...
                  {item.round_complete
                    ...
                    .reverse()}
                  {item.is_admin === 0 &&
                  item.termination_request_sent === 0 ? (
                    <View style={blockCircleOneStyle.paymentButtonView}>
                      <TouchableOpacity
                        style={blockCircleOneStyle.terminateButton}
                        onPress={() => {
